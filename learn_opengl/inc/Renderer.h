...
private:
	...
	// 天空盒环境光照材质对应的shader
	std::shared_ptr<Shader> m_phongEnvShader{ nullptr };
	// 实例化绘制冯氏光照模型材质对应的shader
	std::shared_ptr<Shader> m_phongInstanceShader{ nullptr };
	// 草地实例化绘制材质对应的shader
	std::shared_ptr<Shader> m_grassInstanceShader{ nullptr };
